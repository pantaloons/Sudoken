...
import sudokusolver.ConstraintsExtension;
...
public class FutoshikiConstraints implements ConstraintsExtension {
    ...
    @Override
    public boolean isViolated(int x, int y, SudokuBoard sudokuBoard) {
        ...
        Collection<Cell> neighbouringCells = boardUtils.getNeighbouringCells(
                cell, sudokuBoard);
