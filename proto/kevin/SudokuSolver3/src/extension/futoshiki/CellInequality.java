...
public class CellInequality {
    ...
    /**
     * The method is {@code isViolated} as opposed to {@code isTrue}, as, technically, it
     * is not possible to prove the cell inequality is true if the wrong cells are given. It is
     * only possible to say that the inequality is not violated.
     * 
     * @param a
     * @param b
     * @return
