...
public class FutoshikiParser implements ParserExtension {
    ...
    public void load(String futoshikiConfig) {
        ...
        while(scanner.hasNext()) {
            Cell firstCell = new Cell(new Position(scanner.nextInt(), scanner.nextInt()));
            Inequality inequality = Inequality.fromString(scanner.next());
            Cell secondCell = new Cell(new Position(scanner.nextInt(), scanner.nextInt()));
            CellInequality cellInequality = new CellInequality(firstCell, secondCell, inequality);
