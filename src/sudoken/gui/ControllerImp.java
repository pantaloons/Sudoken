...
import sudoken.gui.errordisplay.ErrorDisplay;
import sudoken.gui.errordisplay.PopupErrorDisplay;
...
public class ControllerImp implements Controller {
    ...
    /**
     * Creates a ControllerImp. The controller is used by the given GUI to
     ...
     *            user input.
     * @return the created ControllerImp
     */
    // A normal constructor could not be used, as
    public static ControllerImp createControllerImp(Solver puzzleSolver,
            SudokenGUI gui) {
